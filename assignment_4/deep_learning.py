...
# SPECIFICATION: Deeplearning using a whole mess of things that don't run on PyCharm
# FOR: CS 4210- Assignment #4
# TIME SPENT: 14 hours installing packages, 10 hours coding
#-----------------------------------------------------------*/
...
for hidden in n_hidden:  # looking or the best parameters w.r.t the number of hidden layers
    for neurons in n_neurons:  # looking or the best parameters w.r.t the number of neurons
        for rate in l_rate:  # looking or the best parameters w.r.t the learning rate
            ...
            print("Parameters: " + "Number of Hidden Layers: " + str(hidden) + ",number of neurons: " + str(neurons) + ",learning rate: " + str(rate))
            print()
